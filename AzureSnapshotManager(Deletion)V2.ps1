...
$global:form.Text = "Azure Snapshot Manager v2.0"
...
function Start-Process {
    ...
    # Load subscriptions first to get accurate count
    ...
    # Single confirmation with actual subscription count
    $confirmation = [System.Windows.Forms.MessageBox]::Show(
        "This will DELETE ALL $($subscriptionIds.Count) subscriptions matching '$snapshotNameFilter'! Continue?",
        "Final Warning - Destructive Operation", 
